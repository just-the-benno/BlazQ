...
namespace BlazQ.MultiplayerServer.Domain
{
    public class PlayerRegistry
    {
        ...
        internal IEnumerable<PlayerServerSide> GetPlayersInLobby(Guid playerId)
        {
            if (_players.ContainsKey(playerId) == false) { return Array.Empty<PlayerServerSide>();  }

            return _players[playerId].Lobby.Players;
        }
    }
}

...
namespace BlazQ.Game
{
    public class GameSession
    {
        ...
        public List<ServerSideQuestionOverview> Questions { get; init; }
        ...
        {
            Players = new List<Player> { firstPlayer };
        }

        public GameSession(List<Player> players, Guid sessionId, Guid playerId, List<ServerSideQuestionOverview> questions)
        {
            Players = players;
            Questions = questions;
        ...
        public ServerSideQuestionOverview GetCurrentQuestion()
        {
        ...
        public Boolean SubmitAnswer(Int32 answerIndex, Int32 playerIndex)
        {
            ...
            ServerSideQuestionOverview currentQuestions = GetCurrentQuestion();
        ...
        public Boolean IsCurrentPlayer(Int32 index)
        {
